...
public final class FileTransferrer implements Loggable {
    ...
    private static final String SOURCE_PATH_2025 = "data/2025";
    private static final String DESTINATION_PATH_2025 = "src/main/resources/com/japps/adventofcode/probs2025";
    private static final Map<String, String> SRC_DEST_MAP = new HashMap<>();

    static {
        SRC_DEST_MAP.put(SOURCE_PATH_2025, DESTINATION_PATH_2025);
    }
